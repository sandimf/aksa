    ...
    <div className="bg-black text-white min-h-screen">
      ...
      <div className="relative h-[100vh] min-h-[100vh]">
        <div className="absolute inset-0">
          <Image
            ...
            priority={true} // Wajib untuk gambar utama (LCP)
      ...
      <section className="py-16 px-6 relative">
        <div className="absolute inset-0 opacity-30">
          {/* PERBAIKAN: Ganti <img> biasa menjadi Image + fill */}
          <Image 
            src="/bg.jpg" 
            alt="Background" 
            fill 
            ...
            sizes="100vw"
            quality={60} // Gambar latar belakang buram tidak butuh kualitas tinggi
          />
        </div>
            ...
            {inReleaseMovies.map((movie, idx) => (
              <div key={idx} className="group cursor-pointer">
                <div className="bg-gray-800 rounded-lg overflow-hidden mb-4 aspect-[2/3] relative">
                  {/* PERBAIKAN: Gunakan fill dan tentukan sizes untuk poster */}
                  <Image 
                    src={movie.image} 
                    alt={movie.title} 
                    fill // Menggunakan fill agar dimensinya responsif
                    className="object-cover" 
                    // Tentukan sizes: 50vw untuk HP (2 kolom), 20vw untuk Desktop (5 kolom)
                    sizes="(max-width: 768px) 50vw, 20vw" 
                    // width/height dihapus karena menggunakan fill
                  />
      ...
      {/* 🚀 3. Trailers Section (Optimasi Iframe) */}
      ...
      <section className="py-16 px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="relative rounded-lg overflow-hidden aspect-video">
            {/* PERBAIKAN: Gunakan fill dan sizes */}
            <Image 
                src="/cover_maira.jpg" 
                alt="Maira" 
                fill 
                className="w-full h-full object-cover" 
                sizes="(max-width: 768px) 100vw, 50vw" // Full width di HP, setengah di desktop
            />
          </div>
          <div className="relative rounded-lg overflow-hidden aspect-video">
            {/* PERBAIKAN: Gunakan fill dan sizes (ingat: ganti .png ke .jpg/.webp jika tidak perlu transparansi) */}
            <Image 
                src="/cover_tegar.png" 
                alt="Tegar" 
                fill 
